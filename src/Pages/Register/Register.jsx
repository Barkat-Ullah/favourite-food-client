        ...
        <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
          <form onSubmit={handleRegister} className="w-full max-w-md">
            <div className="flex items-center justify-center mt-6">
              <a
                href="#"
                className="w-1/3 pb-4 mb-3 font-medium text-center text-gray-800 capitalize border-b-2 border-[#C5A35E] dark:border-[#C5A35E] dark:text-white"
              >
                sign up
              </a>
            </div>
            ...
            <div className="relative flex items-center mb-[-13px]">
              ...
              <input
                ...
                name="name"
                required
                className="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-[#C5A35E] dark:focus:border-[#C5A35E] focus:ring-[#d7c9ac] focus:outline-none focus:ring focus:ring-opacity-40"
